=== Notice Block ===
Contributors: wpdevteam, re_enter_rupok, Asif2BD, rahat89, priyomukul, jamilbd07, hztyfoon, fencermonir
...
- To report issue and contribution visit [Github](https://github.com/EssentialBlocks/notice-block).
- If you have any more questions, visit our support on the [Plugin's Forum](https://wordpress.org/support/plugin/notice-block).
...
= Old Way: =
1. Upload `notice-block` to the `/wp-content/plugins/` directory
